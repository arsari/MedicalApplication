...
public class App {
	...
	public static void main(String[] args) {
		...
		int passwordAttends = 3;
		String password = null;
		boolean loginSuccess = false;

		// Login
		while (passwordAttends > 0 && !loginSuccess) {
	...
	private static void addPerson(boolean addDoctor, Scanner scanner) {
		...
		while (input != 0) {
			...
			if (personAdded) {
				System.out.println(person + " " + response.getOne() + " was successfully added\n");
			} else {
